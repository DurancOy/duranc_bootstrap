...
if [ ! -d "$DIRECTORY" ]; then
	...
	wget -O $HOME/.recovery/master.zip https://portal.duranc.com/duranc_bootstrap/gateway/untrunc/master.zip
	unzip master.zip
	cd $HOME/.recovery/untrunc-master
	wget -O $HOME/.recovery/untrunc-master/v12.3.zip https://portal.duranc.com/duranc_bootstrap/gateway/untrunc/libav/v12.3.zip
